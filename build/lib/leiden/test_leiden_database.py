...
class TestLOVD2Database():
    ...
    def test_get_variant_database_url(cls):
        ...
        assert_equals(cls.database1._get_variant_database_url(), result)
        ...
        assert_equals(cls.database2._get_variant_database_url(), result)
    ...
    def test_get_gene_homepage_url(cls):
        ...
        cls.database1.set_gene_id(input)
        assert_equals(cls.database1._get_gene_homepage_url(), result)
        ...
        cls.database2.set_gene_id(input)
        assert_equals(cls.database2._get_gene_homepage_url(), result)
    ...
    def test_get_transcript_refseqid(cls):
        ...
        result = 'NM_001100.3'
        cls.database1.set_gene_id(input)
        assert_equals(cls.database1.transcript_refseqid(), result)
        ...
        result = 'NM_031885.3'
        cls.database2.set_gene_id(input)
        assert_equals(cls.database2.transcript_refseqid(), result)
