...
class TestLOVD2DatabaseACTA1():
    ...
    def test_get_variant_database_url_with_acta1(cls):
        ...
        assert_equals(cls.database.get_variant_database_url(), result)

    def test_get_gene_homepage_url(cls):
        result = 'http://www.dmd.nl/nmdb2/home.php?select_db=ACTA1'
        assert_equals(cls.database.get_gene_homepage_url(), result)

    def test_get_transcript_refseqid_with_acta1(cls):
        result = 'NM_001100.3'
        assert_equals(cls.database.get_transcript_refseqid(), result)
    ...
    def test_get_table_headers(cls):
        ...
        assert_equals(cls.database.get_table_headers(), result)
...
class TestLOVD3DatabaseBBS1():
    ...
    def test_get_table_data(cls):
        ...
        assert_equals(cls.database.get_table_data(), result)
...
class TestLOVD3DatabaseCTC1():
    ...
    def test_get_table_headers(cls):
        result = ['effect', 'exon', 'dna_change', 'rna_change', 'protein_change', 'dna_change', 'reference',
