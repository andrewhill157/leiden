...
def annotate_vep(input_file, output_file):
    ...
    @param input_file: input VCF file path
    @type input_file: string
    @param output_file: output VCF file path (VEP annotation added to file).
...
def annotate_26k(input_file, output_file):
    ...
    @param input_file: input VCF file path
    @type input_file: string
    @param output_file: output VCF file path (26K allele frequency annotation added to file)
    @type output_file: string
    """
...
def annotate_hgmd(input_file, output_file):
    ...
    @param input_file: input VCF file path
    @type input_file: string
    @param output_file: output VCF file path (HGMD information added to file)
    @type output_file: string
    """
...
def vcf_annotate(input_text, annotation_source, columns, descriptions):
    ...
    @param input_text: Popen object to pipe input text
    @type input_text: Popen object (subprocess module)
    @param annotation_source: path to VCF annotate formatted txt file with reference variants for annotation
    @param columns: columns contained in annotation_source file
    @type columns: string
    @param descriptions: list of description text inputs for VCF annotate.
    @type descriptions: list of strings
    @return: Popen object (subprocess) to output pipe of this annotation
    """
...
def annotate_dbsnp(input_file, output_file):
    ...
    @param input_file: input VCF file path
    @type input_file: string
    @param output_file: output VCF file path (DBSNP information added to file)
    @type output_file: string
    """
...
def annotate_snpeff(input_file, output_file):
    ...
    @param input_file: input VCF file path
    @type input_file: string
    @param output_file: output VCF file path (SNPEff annotation added to file)
    @type output_file: string
    """
